...
namespace iTalk
{
    ...
    class iTalk_Button_1 : Control
    {
        ...
        protected override void OnResize(System.EventArgs e)
        {
            ...
            var cornerSize = Height;
            var _Shape = Shape;
            
            _Shape.AddArc(0, 0, cornerSize, cornerSize, 180, 90);
            _Shape.AddArc(Width - (cornerSize+1), 0, cornerSize, cornerSize, -90, 90);
            _Shape.AddArc(Width - (cornerSize + 1), Height - (cornerSize + 1), cornerSize, cornerSize, 0, 90);
            _Shape.AddArc(0, Height - (cornerSize + 1), cornerSize, cornerSize, 90, 90);
    ...
    class iTalk_TextBox_Big : Control
    {
        ...
        protected override void OnResize(System.EventArgs e)
        {
            ...
            var round = 41;
            var roundMar = round + 1;

            var _with1 = Shape;
            _with1.AddArc(0, 0, round, round, 180, 90);

            _with1.AddArc(Width - roundMar, 0, round, round, -90, 90);

            _with1.AddArc(Width - roundMar, Height - roundMar, round, round, 0, 90);

            _with1.AddArc(0, Height - roundMar, round, round, 90, 90);
